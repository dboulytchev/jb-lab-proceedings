...
\titlerunning{Синтаксический анализ данных в виде КС-грамматик}
...
\input{Kovalev/intro}
\input{Kovalev/statement}
\input{Kovalev/overview}
\input{Kovalev/decidability}
\input{Kovalev/algorithm}
\input{Kovalev/evaluation}
\input{Kovalev/conclusion}

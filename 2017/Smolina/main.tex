...
\titlerunning{Анализ графов с помощью парсер-комбинаторов}
...
\input{Smolina/1_intro}
\input{Smolina/2_problem}
\input{Smolina/3_overview}
\input{Smolina/4_meerkat}
\input{Smolina/5_conclusion}

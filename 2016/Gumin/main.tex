...
\titlerunning{Использование символьных конечных преобразователей}
...
\input{Gumin/1_intro}
\input{Gumin/2_problem}
\input{Gumin/3_overview}
\input{Gumin/6_approbation}
\input{Gumin/7_conclusion}

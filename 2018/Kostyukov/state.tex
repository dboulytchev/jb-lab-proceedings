...
В данной секции мы будем пользоваться сокращением $\ite{c}{a}{b}\eqdef\union{\pair{c}{a},\pair{\neg c}{b}}$.
%
\begin{defn}

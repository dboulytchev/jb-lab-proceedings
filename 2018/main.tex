...
Шестой выпуск трудов лаборатории языковых инструментов JetBrains Research, как обычно, представляет результаты, полученные студентами лаборатории
в рамках подготовки квалификационных работ в 2017-2018 учебном году. Наряду с традиционными для нашей лаборатории направлениями, такими, как
синтаксический анализ, метавычисления, функциональное и реляционное программирование, в этом году диапазон исследований расширился темами
верификации программ, символьного исполнения и анализа систем типов объектно-ориентированных языков.
...
\include{Azimov/main}
\include{Moiseenko/main}
\include{Lozov/main}
\include{Bozhko/main}
\include{Kravchenko/main}
\include{Borovkov/main}
\include{Misonizhnik/main}
\include{Kostyukov/main}

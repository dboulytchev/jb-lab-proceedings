...
\begin{figure}[h!]
	\centering
	% \inputminted{c}{Podkopaev/codes/wikiExUnfor.c}
...
\begin{figure}[h!]
	\centering
	% \inputminted{c}{Podkopaev/codes/wikiExBSD.c}
...
\begin{figure}[h!]
	\begin{subfigure}[b]{0.45\textwidth}
		% \inputminted{haskell}{Podkopaev/codes/ifTemplate2.hs}
	...
	\hspace{1cm}
	\begin{subfigure}[b]{0.45\textwidth}
		% \inputminted{haskell}{Podkopaev/codes/ifTemplate1.hs}
...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.30\linewidth}
		\centering
		% \inputminted{haskell}{Podkopaev/codes/ifCode2.hs}
